...
public class SimpleTest {
    ...
    private void fillRegistrationFields(){
        int randomIntNUmberForRegistration = this.generator.nextInt(1000000);
    ...
    private boolean chooseTypeOfAnswerForQuestion(boolean typeOfAnswer){
    	...
    	questionsAnswersMap.put(new String(questions[0]),new String("Go 4 Rule"));
    	questionsAnswersMap.put(new String(questions[1]),new String("0"));
